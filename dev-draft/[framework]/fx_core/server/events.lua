...
local function OnPlayerConnecting(name, setKickReason, deferrals)
    ...
    deferrals.update(string.format('Client connecting to Neptune, please wait (update_1).'))
    ...
    deferrals.update(string.format('Client connecting to Neptune, please wait (update_2).'))
    ...
    deferrals.update(string.format('Client connecting to Neptune, please wait (update_3).'))

    if not license then
        deferrals.done('Client does not have a valid RK* license!')
